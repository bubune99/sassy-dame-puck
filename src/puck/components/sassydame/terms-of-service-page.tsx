    ...
    <main className="flex-1 py-16">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
          ...
          <p>
            This website is operated by SassyDame Designs, LLC. Throughout the site, the terms
            &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to SassyDame Designs, LLC.
            SassyDame Designs, LLC offers this website, including all information, tools and services
          ...
          <p>
            ...
            illegal or unauthorized purpose nor may you, in the use of the Service, violate any laws
            in your jurisdiction (including but not limited to copyright laws). A breach or violation
          ...
          <p>
            ...
            and involve transmissions over various networks and changes to conform and adapt to technical
          ...
          <p>
            ...
            at any time. We shall not be liable to you or to any third-party for any modification, price
          ...
          <p>
            ...
            according to our Refund Policy. We have made every effort to display as accurately as possible
          ...
          <p>
            ...
            any control nor input. You acknowledge and agree that we provide access to such tools &ldquo;as
            is&rdquo; and &ldquo;as available&rdquo; without any warranties, representations or conditions
            of any kind and without any endorsement.
          </p>

          <h2 className="text-2xl font-bold text-foreground mt-10">Contact Information</h2>
          <p>

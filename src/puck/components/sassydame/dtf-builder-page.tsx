        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block px-3 py-1 rounded-full bg-secondary/10 text-secondary text-sm font-medium mb-4">
              Powered by Drip Apps
            </span>
            <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4">
              DTF Gang Sheet Builder
            </h1>
            <p className="text-muted-foreground text-lg">
              Create custom gang sheets by uploading your designs and arranging them on a
              single transfer sheet. Maximize your space, minimize your costs.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="font-serif text-3xl font-bold mb-6 text-center">How It Works</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
                  <span className="font-bold text-primary">1</span>
                </div>
                <h3 className="font-semibold mb-2">Upload Designs</h3>
                <p className="text-sm text-muted-foreground">
                  Upload your PNG, SVG, or PDF files directly into the builder.
                </p>
              </div>
              <div className="text-center">
                <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="font-semibold mb-2">Arrange & Size</h3>
                <p className="text-sm text-muted-foreground">
                  Drag, resize, and arrange your designs to maximize sheet space.
                </p>
              </div>
              <div className="text-center">
                <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Choose your sheet size, review pricing, and checkout instantly.
                </p>
              </div>
            </div>
          </div>

      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-serif text-4xl md:text-5xl font-bold mb-4 text-foreground">Ready to Get Started?</h2>
            <p className="text-muted-foreground text-lg mb-10 max-w-xl mx-auto">
              Tell us about your project and receive a custom quote within 24 hours. No obligation, no pressure.
            </p>
            ...
            <p className="text-sm text-muted-foreground mt-8 flex items-center justify-center gap-2">
              <Phone className="h-4 w-4" /> Or call us at <strong className="text-foreground">(919) 628-6531</strong>
            </p>
          </motion.div>
        </div>
      </div>

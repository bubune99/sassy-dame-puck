    ...
    <section className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-br from-sassy-fuchsia/10 via-background to-sassy-sky/10">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            Premium UV DTF stickers with stunning color and durability. Perfect for tumblers, laptops, phones, and any hard surface.
          </motion.p>
        </motion.div>
          ...
          {[
            {
              ...
              description: 'Waterproof, scratch-resistant stickers that stick to virtually any hard surface with vivid color',
            ...
            {
              title: 'Custom Sticker Orders',
              description: 'Upload your own design or work with us to create the perfect custom sticker for your brand',
              href: '/custom-order?type=stickers',
              color: 'bg-sassy-sky',
              textColor: 'text-white',
              icon: Palette,
            ...
            {
              title: 'Sticker Bundles',
              description: 'Save big with curated sticker packs — perfect for gifts, resale, or decorating everything in sight',
              href: '/collections/uv-dtf-stickers',
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10 mt-6 flex items-center gap-2 font-semibold text-sm group-hover:gap-4 transition-all">
                      Shop Stickers <ArrowRight className="h-4 w-4" />
                    </div>
                  </div>
                </SpotlightCard>
              </div>
        ...
        >
          <Button
            ...
            onClick={() => window.location.href = '/collections/uv-dtf-stickers'}
          >
            Browse All Stickers
